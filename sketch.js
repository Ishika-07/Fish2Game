...
function preload(){
bgImg=loadImage("oceanbg.jpg");
fishImg = loadImage("yellowfish.gif");
fish2Img = loadImage("fish4.png");
playerImg = loadImage("sprite_fish0.png");
bubbleImg  =loadImage("sprite_bubble0.png");
resetButtonImg = loadImage("sprite_0.png");
fish3Img = loadImage("starfish0.png");

sound  =loadSound("Bulle.wav");
